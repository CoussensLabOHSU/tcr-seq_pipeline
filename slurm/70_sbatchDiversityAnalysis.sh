...
OUT=$data/QC/std/
MYBIN=$tool/60_analysis/diversityAnalysis.R          # Path to shell script or command-line executable that will be used
...
cmd="/home/exacloud/gscratch/CoussensLab/howellsf/R-4.0.2/bin/bin/Rscript $MYBIN $IN $OUT $OLD" 
